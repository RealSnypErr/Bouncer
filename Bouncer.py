...
async def on_member_join(member):
    ...
    if member.bot:
        if member.id not in authorized_bots:
            ...
            embed=discord.Embed(title="**UNAUTHORIZED BOT KICKED**", description=(f"Contact {owner} or any available Moderator/Whitelister to whitelist this bot"), color=0xff0000)
